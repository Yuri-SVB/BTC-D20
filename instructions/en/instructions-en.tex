...
\begin{itemize}[itemsep=1pt]
 \item Never use the seed phrase from the example above: for your private keys to be secret, your seed phrase must be truly random
...
This tutorial is by \textbf{Yuri da Silva Villas Boas} --- author of BIP-450 (Formosa) and creator of the Great Wall protocol. Visit \texttt{www.loudproudandfree.com} in your browser or scan the QR code on the side. There you will find:

\begin{description}[itemsep=1pt]
 \item [More tutorials:] Would you like \textbf{themed phrases} instead of loose words? We have them!
 \item [Courses and consulting:] Get your questions answered by a specialist
 \item [Twitter/X, Nostr and Telegram:] Join the movement and follow us to stay informed

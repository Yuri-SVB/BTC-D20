...
\begin{itemize}[itemsep=1pt]
 \item Non usare mai la frase seme di questo esempio qui sopra: perché, affinché le tue chiavi private restino segrete, hai bisogno che la tua frase seme sia veramente casuale
...
Questo tutorial è opera di \textbf{Yuri da Silva Villas Boas} --- autore della BIP-450 (Formosa) e creatore del protocollo Great Wall. Repository ufficiale (sorgenti, PDF in 4 lingue, verifica automatica): \texttt{github.com/Yuri-SVB/BTC-D20} --- oppure scansiona il codice QR a fianco.

\begin{description}[itemsep=1pt]
 \item [Edizione estesa --- 24 parole:] nello stesso repository: la procedura a 24 parole e la scorciatoia del completamento dell'ultima parola
 \item [Altri tutorial, corsi e comunità:] \texttt{www.loudproudandfree.com} --- e seguici su Twitter/X, Nostr e Telegram

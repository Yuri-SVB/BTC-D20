...
Varias herramientas de semilla completan la última palabra por ti: dadas todas las palabras anteriores, listan exactamente las candidatas que hacen válido el \textit{checksum} --- por ejemplo el flujo \textit{final word} de SeedSigner, la calculadora de última palabra de SeedPicker, el BIP39 Recoverer offline de Coinplate o la página BIP39 de Ian Coleman (usada offline). Para una semilla de 12 palabras existen siempre exactamente \textbf{128 últimas palabras válidas: precisamente una en cada una de las $8\times16=128$ filas} de la tabla. Así que, en vez del ensayo y error columna por columna: tira D1 y D2 como de costumbre y toma, entre las candidatas del asistente, \textbf{la que esté en tu sección y fila tiradas}. La misma palabra, la misma entropía, menos tecleo.
...
\begin{description}[itemsep=1pt]
 \item [Artículo corto:] por qué un aviso discreto era imposible --- Kerckhoffs y el incidente de julio de 2026: \texttt{posts/kerckhoffs-lemma-coldcard.md} en el repositorio
...
\editionsfooter{Rev. 2026-08 --- Extendida}

...
Este tutorial es obra de \textbf{Yuri da Silva Villas Boas} --- autor de la BIP-450 (Formosa) y creador del protocolo Great Wall. Repositorio oficial (fuentes, PDF en 4 idiomas, verificación automática): \texttt{github.com/Yuri-SVB/BTC-D20} --- o escanea el código QR al lado.

\begin{description}[itemsep=1pt]
 \item [Edición extendida --- 24 palabras:] en el mismo repositorio: el procedimiento de 24 palabras y el atajo de autocompletado de la última palabra
 \item [Más tutoriales, cursos y comunidad:] \texttt{www.loudproudandfree.com} --- y síguenos en Twitter/X, Nostr y Telegram
